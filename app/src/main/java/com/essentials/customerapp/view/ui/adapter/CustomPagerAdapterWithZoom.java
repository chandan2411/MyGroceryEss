...
public class CustomPagerAdapterWithZoom extends PagerAdapter {
    Context context;
    ...
    public CustomPagerAdapterWithZoom(Context context) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View view = LayoutInflater.from(context).inflate(R.layout.pager_item_with_zoom, container, false);
