    ...
    private class GetLatestVersion extends AsyncTask<String, String, String> {
            ...
            if(!currentVersion.equals(latestVersion)&&latestVersion!=null){
                ...
                builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //Click button action
                        activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.essentials.customerapp&hl=it")));
                        dialog.dismiss();
                    }
                });
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                latestVersion = Jsoup.connect("https://play.google.com/store/apps/details?id=com.essentials.customerapp&hl=it")
                        .timeout(30000)
